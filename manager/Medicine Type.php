...
<div class="main">
    <header>
        <h1><i class="bi bi-list-check"></i>  <span class="text-danger font-weight-bold"> MEDICINE</span> <span class="text-success font-weight-bolder">TYPE</span></h1>
    </header>
    <div class="form_button">
        <form method="POST" action="addmedtype.php">
            <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="Brand">Medicine Type</label>
                  <input type="text" 
                         class="form-control" 
                         name="Medtype_name" 
				 ...
				 {           
                  ...
                  <tr id="myUL">
                    <th><?php echo $count ?></th>
                     <th><?php echo $row["Medicine Type"] ?></th>
					  
					  <th>
            <a href="deletemedtype.php?id=<?php echo $row["id"] ?>"><button class="btn btn-danger btn-md text-white">Delete <i class="bi bi-trash-fill"></i></button></a></th>
